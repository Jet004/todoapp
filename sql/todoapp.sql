...
--
-- Host: localhost:8889
-- Generation Time: Aug 21, 2021 at 03:51 AM
...
(1, 'bobthebuilder', 'passw0rd', 'bob@builder.com');
...
--
ALTER TABLE `todoitems`
  ADD CONSTRAINT `todoitems_ibfk_1` FOREIGN KEY (`catid`) REFERENCES `todocategory` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
